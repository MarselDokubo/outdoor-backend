...
import type { ArchivePostCommand, PostView } from "../contracts.js";

export class ArchivePostUseCase {
  constructor(private readonly postRepository: PostRepository) {}

  public async execute(command: ArchivePostCommand): Promise<PostView> {
    ...
    post.archive(command.actorUserId);
